...
#ifndef _SIM2EDITOR_NDS_SLOT_SELECTION_HPP
#define _SIM2EDITOR_NDS_SLOT_SELECTION_HPP

#include "Pointer.hpp"
#include <string>
#include <vector>

class NDSSlotSelection {
public:
	NDSSlotSelection() { }
	int8_t Action() const;
private:
	struct NDSSlotInformation {
		int8_t Slot = 0;
		std::string SimoleonString = "0$";
		std::string SimName = "";
	};

	mutable int8_t Res = 0;
	mutable bool Done = false;
	mutable NDSSlotInformation Info;
